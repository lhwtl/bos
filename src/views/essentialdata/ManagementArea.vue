...
<div class="divClass">
  ...
  <!--数据表格-->
   <el-table :data="result" style="width: 100%;" :border="true" max-height="550">
     ...
     <el-table-column prop="zonecode" label="定区编码" min-width="80"></el-table-column>
     <el-table-column prop="zonename" label="定区名称" min-width="60"></el-table-column>
     <el-table-column prop="syEmp.empname"  label="定区负责人" min-width="60"></el-table-column>
     <el-table-column prop="telphone" label="联系电话" min-width="50"></el-table-column>
     <el-table-column prop="syUnits.name" label="所属单位" min-width="70"></el-table-column>
     <el-table-column>
       <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" @click="handleEdit(scope.row)">查看客户信息</el-button>
          </template>
        </el-table-column>
     </el-table-column>
