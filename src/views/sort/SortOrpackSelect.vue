<template>
 ...
 <el-form :inline="true" class="demo-form-inline" style="margin-top: 10px;text-align: left;margin-left: 30px;">
    ...
    <el-table :data="result" style="width: 100%;" :border="true" max-height="550">
      ...
      <el-table-column prop="rolename" label="封签号" min-width="50"></el-table-column>
      <el-table-column prop="roledesc"  label="合包人"  min-width="70"></el-table-column>
      <el-table-column prop="id" label="合包单位" min-width="30" align="center"></el-table-column>
      ...
      <el-table-column prop="id" label="记录人" min-width="30" align="center"></el-table-column>
      <el-table-column prop="rolename" label="记录时间" min-width="50"></el-table-column>
